...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="relative overflow-hidden w-full max-w-full">
      {/* Carousel Container */}
      <div className="relative group w-full max-w-full h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] overflow-hidden bg-gradient-to-br from-[#EFE9D8] via-[#F5F0E5] to-[#EFE9D8]">
